...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  clubs = {
     ...
     * @secure
     */
    clubsControllerFindOne: (id: string, params: RequestParams = {}) =>
      this.request<Club, any>({
        path: `/clubs/${id}`,
        method: 'GET',
        secure: true,
     ...
     * @request PATCH:/clubs/{id}
     * @secure
     */
    clubsControllerUpdate: (id: string, data: UpdateClubDto, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/clubs/${id}`,
        method: 'PATCH',
        body: data,
     ...
     * @request DELETE:/clubs/{id}
     * @secure
     */
    clubsControllerRemove: (id: string, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/clubs/${id}`,
        method: 'DELETE',
        secure: true,
